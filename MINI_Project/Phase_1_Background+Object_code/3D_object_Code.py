...
def draw_3d_cube():
    ...
    def connect_points(i, j, points):
        pygame.draw.line(window, (255, 255, 255), (points[i][0], points[i][1]), (points[j][0], points[j][1]), 2)
    ...
    while running:
        ...
        for point in cube_points:
            rotate_z = multiply_m(rotation_z, point)
            rotate_x = multiply_m(rotation_x, rotate_z)
            rotate_y = multiply_m(rotation_y, rotate_x)
            point_2d = multiply_m(projection_matrix, rotate_y)
